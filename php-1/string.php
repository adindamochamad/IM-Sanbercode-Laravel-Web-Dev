...
<body>
        ...
        */
          ...
          // Soal No 1 - Menampilkan panjang string dan jumlah kata
          ...
          echo "Panjang string: " . strlen($second_sentence) . ", Jumlah kata: " . str_word_count($second_sentence) . "<br><br>";
        ...
        */
          ...
          echo "String setelah diubah: \"$string3_modified\"";
